...
scoreboard objectives add drop_carrotStick minecraft.dropped:minecraft.carrot_on_a_stick
scoreboard objectives add range dummy
scoreboard objectives add pumpgun_ammo dummy
scoreboard objectives add pumpgun_cooldown dummy
scoreboard objectives add weapon_mode dummy
scoreboard objectives add has_reloaded dummy
scoreboard objectives add fire_ammo dummy
scoreboard objectives add poison_ammo dummy
scoreboard objectives add poisoned dummy
scoreboard objectives add poisoned_tick dummy
