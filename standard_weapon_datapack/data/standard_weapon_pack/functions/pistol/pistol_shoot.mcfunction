scoreboard players remove @s pistol_ammo 1
...
execute at @s anchored eyes positioned ^ ^ ^ run function standard_weapon_pack:pistol/pistol_raycast
execute at @s run teleport @s ~ ~ ~ ~ ~-2
tag @s remove shooter
scoreboard players reset @s fire_ammo
scoreboard players reset @s poison_ammo
execute unless score @s pistol_ammo matches 1.. run function standard_weapon_pack:pistol/pistol_reload_apply