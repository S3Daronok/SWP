...
execute as @s[nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{weapon_mode:2b}}}] unless score @s pumpgun_cooldown matches 1.. run function standard_weapon_pack:pumpgun/pumpgun_reload
execute as @s[scores={carrotOnaStick=1..},nbt={SelectedItem:{id:"minecraft:carrot_on_a_stick",tag:{pumpgun:1b}}}] unless score @s pumpgun_cooldown matches 1.. if score @s pumpgun_ammo matches 1.. run function standard_weapon_pack:pumpgun/pumpgun_shoot
